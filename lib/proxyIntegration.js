    ...
    try {
        ...
        if (event.body) {
            try {
                ...
                return Promise.resolve({statusCode: 400, headers, body: 'body is not a valid JSON'});
            }
        }
        return Promise.resolve(actionConfig.action(event, context))
            .then(body => {{statusCode: 200, headers, body}})
